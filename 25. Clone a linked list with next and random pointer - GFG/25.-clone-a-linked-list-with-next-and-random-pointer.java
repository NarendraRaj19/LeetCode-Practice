...
class Clone {
    ...
    Node copyList(Node head) {
        ...
        //Create New Nodes which is a copy of the Original Nodes
        while(curr != null){
        ...
        //Attach Random Pointers to the New Nodes created
        curr = head;
        ...
        //Detach the cloned nodes from the original Linked List
        
        Node original = head, clone = head.next,  temp = clone;
